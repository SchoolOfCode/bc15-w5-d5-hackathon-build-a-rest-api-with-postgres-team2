...
async function resetDatabase() {
  try {
    ...
    await pool.query(`
      ...
      VALUES 
        (1, '1 tbsp vegetable oil 50g butter 1 onion finely chopped 150g maple-cured bacon, cut into small pieces', 'In a large pan, heat oil and 25g butter, then sauté onions and bacon until soft. Add pumpkin, stock, and simmer for 40 minutes. Stir in cream, blend until smooth, adjust consistency with liquid, strain, and set aside. In a separate pan, melt the remaining butter and fry the remaining bacon with black pepper for 5 minutes. Divide the bacon among four bowls, reheat the soup, and pour it over the bacon. Finish by sprinkling pumpkin seeds and drizzling with maple syrup before serving.'),
        (2, '80g butter 275g digestive or ginger biscuits 1 large egg white 800g full-fat soft cheese 425g can pumpkin purée 200g light brown soft sugar 50g plain flour 5 large eggs + 1 large yolk', 'Prepare a cake tin, make a biscuit base, mix a pumpkin cheesecake filling, bake in a water bath, cool, chill overnight, and serve with whipped cream, cinnamon, pecans, and caramel sauce.'),
        (3, 'Onion Carrots Potato Olive oil Small guinea fowl Butter Smoked bacon Garlic cloves Thyme sprigs Chicken stock White wine Plain flour Redcurrant jelly', 'Roast the seasoned guinea fowl with bacon on a bed of vegetables, add garlic, thyme, stock, and wine, roast until the bird is cooked, then roast the vegetables separately, make a sauce from the pan juices with butter, flour, and redcurrant jelly, and serve the sliced bird, crispy bacon, and vegetables with the sauce on the side.'),
